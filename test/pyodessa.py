...
class OdessaBase:
    ...
    def get(self, name):
        ...
        if "MESH" in name or "FACE" in name or "PIPE" in name or "WALL" in name or "VOLUME" in name or "JUNCTION" in name or "CONNECTI" in name or "SOURCE" in name or "PUMP" in name or "VALVE" in name:
            return [1.0, 2.0]
