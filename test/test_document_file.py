...
class AssasDocumentFileTest(unittest.TestCase):
    ...
    def test_set_document(self) -> None:
    ...
    def test_set_general_meta_values_invalid_type(self) -> None:
